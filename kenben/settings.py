"""
Django settings for kenben project.
...
CORS_ALLOW_ALL_ORIGINS = [
    ...
    'https://sarah-zimmermann-schmutzler.developerakademie.net/kenben_frontend/index.html',
]
...
WSGI_APPLICATION = 'kenben.wsgi.application'
